...
Volem analitzar el nombre més gran d'atributs possibles, però en el cas de l'atribut Name i el PassangerId, no ens aporten informació, així que els eliminarem.

Agafarem l'atribut survived com a referència i utilitzant diferents mètodes estadístics, veurem quin impacte tenen sobre aquest atribut.
...
Eliminem els atributs que no interessen, ja que no aporten informació.
